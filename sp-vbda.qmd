...
**Revenue bonds:** Revenue bonds issued by VBDA for any mixed-use or residential project would be backed by the development’s future income. The City does not guarantee any debt and has no expenses other than staff time dedicated to preparing and executing the issuance. Fees received by the applicant may cover that cost.
...
Increased administrative costs may be funded by additional support for personnel in the Department of Economic Development and VBDA budgets.
