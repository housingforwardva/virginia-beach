...
In FY 2022-23, Development Services Center (DSC) reviewed nearly 2,800 plans. Its FY 2023-24 budget is about $3.1 million, which funds 28 FTE positions. This reflects no change from the previous year.

The Department of Planning and Community Development also has a Development Liaison team, which is not part of DSC. This team guides and coordinates development proposals for applicants, for a range of project types and sizes.
:::
...
The assessment can also align with two recent upgrades for the department.

* **Revised stormwater management regulations:** Staff have implemented changes to these regulations approved by the City Council in early 2022, with a focus on streamlining development plan reviews. Recent changes include simplifying stormwater assessments by using Excel spreadsheet calculations rather than more complex modeling software. Similar improvements should be explored in other processes.
...
::: callout-tip
### Norfolk “Missing Middle” Pattern Book

The Norfolk Missing Middle Pattern Book serves as an exemplary model for localities seeking to promote affordable housing. This resource showcases pre-approved building designs that align with the specific needs and characteristics of Norfolk, facilitating easier and more efficient development processes for builders and developers. By offering a range of vetted design options, the Pattern Book streamlines the approval process, reduces uncertainties, and encourages the development of diverse housing types. This approach can be adapted by other localities to address their unique housing challenges, supporting strategic growth and affordability in housing markets.

For more information: [City of Norfolk Missing Middle Pattern Book](https://www.norfolk.gov/DocumentCenter/View/66555/MissingMiddlePatternBook) (PDF)
:::

To ensure smart development, the City could set specific criteria to benefit from the “fast track,” such as requiring the property to be in a designated growth zone. Aligning the “fast track” with the future residential use recommendations in the new comprehensive plan is also critical. For a “fast track” to be effective, it should likely only apply to developments that are a permitted use in the property’s base zoning. Public hearings to approve a conditional or special use would introduce significantly higher costs and timelines.
