...
* [Strategic priorities]{.hfv-grass-bold} that build the City’s capacity to make significant strides, but may require substantial planning and investment.
* [Easy wins]{.hfv-shadow-bold} that require fewer decision points and could demonstrate meaningful success in the near future.
* [Background work]{.hfv-desert-bold} activities that take advantage of ongoing or upcoming efforts to improve the City’s planning, regulatory, and operational approaches to housing.
...
[Thankless tasks]{.hfv-berry-bold}
